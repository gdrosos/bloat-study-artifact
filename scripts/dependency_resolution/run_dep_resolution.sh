...
if [ "$SAMPLE" = "sample" ]; then
    ...
    python3.9 merge_json.py -d $DEST_DIR -o project_dependencies_100.json
else
    ...
    python3.9 merge_json.py -d $DEST_DIR -o python_projects.json
fi
echo "Dependency resolution completed completed."
